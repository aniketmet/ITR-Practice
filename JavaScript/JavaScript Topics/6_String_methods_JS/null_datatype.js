...
//It means the variable exists, but currently contains no value.
...
//Why is null used?
// Suppose a user is not found in a database:
// let user = null;
// This means:
// User exists conceptually,but currently no object is available.
...
let num3 = 1245;
console.log(num + num3); // invalid.  // error cannot mix bigint with other types.
// We can possible this by type casting.
// Typpe Casting Like this : console.log(num + BigInt(num3));
...
// Used to indicate absence of an object reference.

// BigInt :-
// Used for very large integers.
// Created using BigInt() or by adding n at the end.
// typeof bigintValue returns "bigint".
// Cannot directly mix BigInt and Number.
